...
$sql = "select p.TrainNo,p.TrainName,tp.PnrNo,tp.PassengerName,tp.PassengerGender,tp.PassengerAge,tp.SourceStation,tp.DestStation,tp.TravelDate,tp.PnrStatus from train_pnr_demo2 tp, traininfo p where tp.PnrNo = '".$_POST['number']."' and p.TrainId = tp.TrainId";
