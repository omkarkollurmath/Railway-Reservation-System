  ...
  <head>
   ...
   <body>
    <?php
      ...
      $strQuery = "SELECT distinct(t.Class) as class , count(distinct(t.Class)) as count FROM train_pnr_demo2 t  where t.TrainId = 3 and t.TravelDate like '2018-10-12' group by t.Class";
